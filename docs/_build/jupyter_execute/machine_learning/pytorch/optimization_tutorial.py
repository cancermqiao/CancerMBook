...
# the [previous section](./autogradqs_tutorial.ipynb), and **optimizes** these parameters using gradient descent. For a more
...
# ## Prerequisite Code
# 
# We load the code from the previous sections on [Datasets & DataLoaders](./data_tutorial.ipynb)
# and [Build Model](./buildmodel_tutorial.ipynb)
